...
func (m *WhisperServer) WhisperMarkdown(ctx context.Context, req *proto.WhisperMarkdownRequest) (*emptypb.Empty, error) {
	...
	err = m.Impl.Markdown(
		...
		&whisper.WhisperContentMarkdown{
...
func (m *WhisperServer) WhisperDisambiguation(req *proto.WhisperDisambiguationRequest, stream proto.Whisper_WhisperDisambiguationServer) error {
	...
	elements := make(map[string]whisper.WhisperContentDisambiguationElement, len(req.Elements))
	for key, elementsProto := range req.Elements {
		...
		case *proto.WhisperDisambiguationElement_Option_:
			elements[key] = &whisper.WhisperContentDisambiguationElementOption{
				...
				OnChange: func(key string) {
					...
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Checkbox onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperDisambiguationElement_Text_:
			elements[key] = &whisper.WhisperContentDisambiguationElementText{
	...
	_, err = m.Impl.Disambiguation(
		...
		&whisper.WhisperContentDisambiguation{
			Label:    req.Meta.Label,
			Markdown: req.Markdown,
			Elements: elements,
		},
	...
	if err != nil {
		fmt.Println("WhisperServer.WhisperDisambiguation -> m.Impl.Disambiguation: error => ", err.Error())
	}
...
func (m *WhisperServer) WhisperForm(req *proto.WhisperFormRequest, stream proto.Whisper_WhisperFormServer) error {
	...
	for key, inputProto := range req.Inputs {
		...
		case *proto.WhisperFormInput_Email_:
			inputs[key] = &whisper.WhisperContentFormInputEmail{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Email onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Markdown_:
			inputs[key] = &whisper.WhisperContentFormInputMarkdown{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Markdown onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Number_:
			inputs[key] = &whisper.WhisperContentFormInputNumber{
				...
				OnChange: func(value float32) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Number onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Password_:
			inputs[key] = &whisper.WhisperContentFormInputPassword{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Password onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Radio_:
			inputs[key] = &whisper.WhisperContentFormInputRadio{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Radio onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Select_:
			inputs[key] = &whisper.WhisperContentFormInputSelect{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Select onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Tel_:
			inputs[key] = &whisper.WhisperContentFormInputTel{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Tel onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Text_:
			inputs[key] = &whisper.WhisperContentFormInputText{
				...
				OnChange: func(value string) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Text onChange: error => ", err.Error())
					}
				},
			}
		case *proto.WhisperFormInput_Time_:
			...
			inputs[key] = &whisper.WhisperContentFormInputTime{
				...
				OnChange: func(value time.Time) {
					...
					// TODO: Fix this when we refactor to sidekick
					if err != nil {
						fmt.Println("WhisperServer.WhisperForm -> Time onChange: timestamp conversion error => ", err.Error())
					}
	...
	// TODO: Fix this when we refactor to sidekick
	if err != nil {
		fmt.Println("WhisperServer.WhisperForm -> m.Impl.Form: error => ", err.Error())
	}
...
func (m *WhisperServer) WhisperList(ctx context.Context, req *proto.WhisperListRequest) (*emptypb.Empty, error) {
	...
	content, err := whisper.WhisperContentListFromProto(req)
	if err != nil {
	...
	if err != nil {
		return nil, fmt.Errorf("WhisperServer.WhisperList -> m.Impl.List: error => %w", err)
	}
