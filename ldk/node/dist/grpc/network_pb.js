...
proto.proto.Header = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, proto.proto.Header.repeatedFields_, null);
};
 ...
 * @const
 */
proto.proto.Header.repeatedFields_ = [1];
 ...
 * @return {!Array<string>}
 */
proto.proto.Header.prototype.getValuesList = function () {
 ...
 */
proto.proto.Header.prototype.setValuesList = function (value) {
 ...
 * @return {!proto.proto.Header} returns this
 */
proto.proto.Header.prototype.addValues = function (value, opt_index) {
 ...
 * @return {!proto.proto.Header} returns this
 */
proto.proto.Header.prototype.clearValuesList = function () {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.proto.HTTPRequestMsg.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            headersMap: (f = msg.getHeadersMap()) ? f.toObject(includeInstance, proto.proto.Header.toObject) : []
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
        ...
        switch (field) {
            ...
            case 5:
                ...
                reader.readMessage(value, function (message, reader) {
                    jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.proto.Header.deserializeBinaryFromReader, "", new proto.proto.Header());
                });
                break;
            default:
                reader.skipField();
...
proto.proto.HTTPRequestMsg.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f && f.getLength() > 0) {
        f.serializeBinary(5, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.proto.Header.serializeBinaryToWriter);
    }
};
/**
...
/**
 * map<string, Header> headers = 5;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.proto.Header>}
 */
proto.proto.HTTPRequestMsg.prototype.getHeadersMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,!proto.proto.Header>} */ (jspb.Message.getMapField(this, 5, opt_noLazyCreate, proto.proto.Header));
};
/**
...
proto.proto.HTTPResponseMsg.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getHeadersMap(true);
    if (f && f.getLength() > 0) {
        f.serializeBinary(3, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.proto.Header.serializeBinaryToWriter);
    }
};
/**
...
proto.proto.HTTPResponseMsg.prototype.getHeadersMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<string,!proto.proto.Header>} */ (jspb.Message.getMapField(this, 3, opt_noLazyCreate, proto.proto.Header));
};
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.proto.HTTPResponseMsg} returns this
